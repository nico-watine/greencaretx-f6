...
description: Commercial &amp; Residential Indoor Plant Care Services in Houston, TX - Call for your free consultation!
og-title: Servicing Plants, Serving People | Greencare Interior Plants
og-description: Commercial &amp; Residential Indoor Plant Care Services in Houston, TX - Call 713-864-5300 for your free consultation and next day quote!
og-image:
body-id: index
body-class: index
---
<div class="hero-full-screen safe-padding-inset">
	...
	<div class="button-wrap" data-magellan data-threshold="0">
		<a href="#main-content-section" class="cta button">Schedule your free consultation</a>
	</div>
</div>

<div id="main-content-section" data-magellan-target="main-content-section">
	<section class="contact-banner light-banner">
		<div class="row">
...
<section class="people-plants-slogan-section">
	<div class="row expanded collapse">
		...
		<div class="large-6 columns prose-column">
			<div class="prose-wrap">
				<h3 class="h3 separator-left">We are not in the plant business, <br>serving people.</h3>
...
<section class="contact-banner dark-banner" id="contact-banner" data-magellan-target="contact-banner">
	<div class="row">
		<div class="large-7 columns prose-column">
			<div class="prose-wrap float-center large-float-right">
		...
		<div class="row">
			<div class="column">
				<div class="prose-wrap float-center">
					...
					<p class="h4">Founded in 2002, Greencare Interior Plants, LLC, is a family-owned and operated business. We take pride in our reputation for reliable service, original design and great care of our customers and employees.</p>
					<p class="h4">Working with both Commercial and Residential accounts throughout the Greater Houston area, we have the maintenance program and greenery selection to exceed the professional plant care service you expect.</p>
				</div>
			</div>
		</div>
	</div>
