...
<section class="services-section">
	<div class="grid-container">
		<h2 class="h2 font-weight-bold text-center mb-40">We offer 3 options to best suit your needs</h2>
		<div class="grid-x grid-padding-x">
			<div class="cell medium-4">
				<div class="service-option-card flex-container flex-dir-column">
					...
					<a href="#" class="m-0 button large font-weight-bold mt-20 mb-0 expanded border-rounded">Sign Up</a>
				</div>
			</div>
			<div class="cell medium-4">
				<div class="service-option-card flex-container flex-dir-column">
